...
This button moves you to the "sign in" surface. If you already sign user you can use your own account. If not, you can ask invitation across the "registration" button.
...
# Loged-in surface
After login you will see your profile page. The topside is divided to three main part: Main headline, sub-headline and user informations.
See in Fig 1.
...
This part contain your profile, including the following sub-parts
